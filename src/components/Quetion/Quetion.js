...
const Quetion = () => {
    return (
        <div className='Queition-aria'>
            ...
            <p>Answer: React JS. It is an interactive user interface (UI) based JavaScript framework
            ...
            <p>Answer: Props are read-only. It allows data to be passed from one element to another. Like an argument passed to a function
